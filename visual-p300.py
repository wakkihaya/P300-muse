...
subject_id = 1
session_nb = "6_emotion"  # {}_normal: red/blue, {}_emotion: scared/peace,
record_duration = 100
...
oddball_task_gui.present(duration=record_duration,
                         eeg=eeg_device, save_fn=save_fn, targetImg='stimulus/scared_3.jpeg', nonTargetImg='stimulus/sky.jpeg')
